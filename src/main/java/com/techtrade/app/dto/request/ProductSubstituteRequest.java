...
public class ProductSubstituteRequest {
    ...
    /*
     * public Integer getQuantity() { return _quantity; } public void
     * setQuantity(Integer quantity) { _quantity = quantity; }
     */
	...
	return "id = " + getBillId() + " old = " + getOldProduct() + " new = " +
		getNewProduct();
